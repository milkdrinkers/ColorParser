...
public class PlaceholderAPIProvider implements PlaceholderProvider<PaperPlaceholderContext> {
    @Override
    ...
    @Override
    public @NotNull BiFunction<@NotNull PaperPlaceholderContext, @NotNull String, @NotNull String> getStringResolver() {
        return this::getStringResolver;
    }

    public @NotNull String getStringResolver(@NotNull PaperPlaceholderContext context, @NotNull String text) {
    ...
    private @NotNull String player(final @NotNull PaperPlaceholderContext context, final @NotNull String text) {
    ...
    private @NotNull String relational(final @NotNull PaperPlaceholderContext context, final @NotNull String text) {
